...
begin
  ...
  edtDataCad.Text := DateToStr(aFormaPag.GetDataCad);
  edtUltAlt.Text  := DateToStr(aFormaPag.GetUltAlt);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      aFormaPag.SetDataCad(StrToDate(self.edtDataCad.Text));
      aFormaPag.SetUltAlt(StrToDate(self.edtUltAlt.Text));
