...
begin
  ...
  edtDataCad.Text   := DateToStr(oCliente.GetDataCad);
  edtUltAlt.Text    := DateToStr(oCliente.GetUltAlt);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      oCliente.SetDataCad(StrtoDate(edtDataCad.Text));
      oCliente.SetUltAlt(StrToDate(edtUltAlt.Text));
