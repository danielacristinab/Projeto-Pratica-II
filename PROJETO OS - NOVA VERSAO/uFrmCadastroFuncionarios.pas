...
begin
  ...
  edtDataCad.Text   := DateToStr(oFuncionario.GetDataCad);
  edtUltAlt.Text    := DateToStr(oFuncionario.GetUltAlt);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      oFuncionario.SetDataCad(StrToDate(edtDataCad.Text));
      oFuncionario.SetUltAlt(StrToDate(edtUltAlt.Text));
