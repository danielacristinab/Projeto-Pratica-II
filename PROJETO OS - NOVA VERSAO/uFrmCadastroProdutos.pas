...
begin
  ...
  edtDataCad.Text := DateToStr(oProduto.GetDataCad);
  edtUltAlt.Text  := DateToStr(oProduto.GetUltAlt);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      oProduto.SetDataCad(strtodate(self.edtDataCad.Text));
      oProduto.SetUltAlt(strtodate(self.edtUltAlt.Text));
