...
begin
  ...
  edtDataCad.Text := DateToStr(oModelo.GetDataCad);
  edtUltAlt.Text  := DateToStr(oModelo.GetUltAlt);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      oModelo.SetDataCad(Strtodate(self.edtDataCad.Text));
      oModelo.SetUltAlt(strtodate(self.edtUltAlt.Text));
...
procedure TFrmCadastroModelos.SetConsulta(pObj: TObject);
begin
  inherited;
  umFrmConsultaMarcas := TFrmConsultaMarcas(pObj);
end;
