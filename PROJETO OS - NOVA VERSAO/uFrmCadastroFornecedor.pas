...
begin
  ...
  edtDataCad.Text       := DateToStr(oFornecedor.GetDataCad);
  edtUltAlt.Text        := DateToStr(oFornecedor.GetUltAlt);
end;
...
begin
  ...
  begin
    ...
    begin
      showmessage('Campo Razão Social obrigatorio!');
    ...
    begin
      ...
      oFornecedor.SetDataCad(StrToDate(edtDataCad.Text));
      oFornecedor.SetUltAlt(StrToDate(edtUltAlt.Text));
