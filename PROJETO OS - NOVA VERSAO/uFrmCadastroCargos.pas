...
begin
  ...
  edtDataCad.Text := DateToStr(oCargo.GetDataCad);
  edtUltAlt.Text  := DateToStr(oCargo.GetUltAlt);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      oCargo.SetDataCad(StrToDate(self.edtDataCad.Text));
      oCargo.SetUltAlt(StrToDate(self.edtUltAlt.Text));
