...
begin
  ...
  umCadastroFormaPag.limpaEdit;
  umCadastroFormaPag.carregaEdit;
  btn_nome := umCadastroFormaPag.btnSalvar.Caption;
  umCadastroFormaPag.btnSalvar.Caption := '&Excluir';
  umCadastroFormaPag.bloqueiaEdit;
  umCadastroFormaPag.ShowModal;
  umCadastroFormaPag.DesbloqueiEdit;
  umCadastroFormaPag.btnSalvar.Caption := btn_nome;
  self.DBGrid1.DataSource := TDataSource(aCtrlFormaPag.GetDS);
  aCtrlFormaPag.Pesquisar(EdtPesquisar.Text);
end;
