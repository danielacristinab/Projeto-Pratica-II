...
begin
  ...
  edtDataCad.Text := DateToStr(oPais.GetDataCad);
  edtUltAlt.Text  := DateToStr(oPais.GetUltAlt);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      oPais.SetDataCad(StrToDate(self.edtDataCad.Text));
      oPais.SetUltAlt(StrToDate(self.edtUltAlt.Text));
